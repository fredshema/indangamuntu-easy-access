...
if (isset($_POST['signup'])) {
    $citizenFirstName = mysqli_real_escape_string($con, $_POST['citizenFirstName']);
    $citizenLastName  = mysqli_real_escape_string($con, $_POST['citizenLastName']);
    $citizenEmail     = mysqli_real_escape_string($con, $_POST['citizenEmail']);
    $icCitizen     = mysqli_real_escape_string($con, $_POST['icCitizen']);
    $password         = mysqli_real_escape_string($con, $_POST['password']);
    $month            = mysqli_real_escape_string($con, $_POST['month']);
    $day              = mysqli_real_escape_string($con, $_POST['day']);
    $year             = mysqli_real_escape_string($con, $_POST['year']);
    $citizenDOB       = $year . "-" . $month . "-" . $day;
    $citizenGender = mysqli_real_escape_string($con, $_POST['citizenGender']);
    //INSERT
    $query = " INSERT INTO citizen (  icCitizen, password, citizenFirstName, citizenLastName,  citizenDOB, citizenGender,   citizenEmail )
VALUES ( '$icCitizen', '$password', '$citizenFirstName', '$citizenLastName', '$citizenDOB', '$citizenGender', '$citizenEmail' ) ";
...
<head>
    ...
    <title>Asked Appointment Application</title>
    <!-- Bootstrap -->
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <form class="form" role="form" method="POST" accept-charset="UTF-8">
                                            <div class="form-group">
                                                <label class="sr-only" for="icCitizen">Email</label>
                                ...
                                <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6 col-md-6">
                                            <input type="text" name="citizenFirstName" value="" class="form-control input-lg" placeholder="First Name" required />
                                        </div>
                                        <div class="col-xs-6 col-md-6">
                                            <input type="text" name="citizenLastName" value="" class="form-control input-lg" placeholder="Last Name" required />
                                        </div>
                                    </div>

                                    <input type="text" name="citizenEmail" value="" class="form-control input-lg" placeholder="Your Email" required />
                                    <input type="number" name="icCitizen" value="" class="form-control input-lg" placeholder="Your IC Number" required />
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" name="citizenGender" value="male" required />Male
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="citizenGender" value="female" required />Female
                                    </label>
                                    <br />
