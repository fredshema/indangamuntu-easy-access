...
//INSERT
$query = " INSERT INTO employeeschedule (  scheduleDate, scheduleDay, startTime, endTime,  bookAvail)
...
<html lang="en">
    <head>
        ...
        <title>Welcome Addmin <?php echo $userRow['employeeFirstName'];?> <?php echo $userRow['employeeLastName'];?></title>
        <!-- Bootstrap Core CSS -->
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="employeedashboard.php">Welcome Admin <?php echo $userRow['employeeFirstName'];?> <?php echo $userRow['employeeLastName'];?></a>
                </div>
                <!-- Top Menu Items -->
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li class="active">
                            <a href="addschedule.php"><i class="fa fa-fw fa-table"></i> Employee Schedule</a>
                        </li>
                        <li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel panel-primary filterable">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            while ($employeeschedule=mysqli_fetch_array($result)) {
                                
                              
                                echo "<tbody>";
                                echo "<tr>";
                                    echo "<td>" . $employeeschedule['scheduleId'] . "</td>";
                                    echo "<td>" . $employeeschedule['scheduleDate'] . "</td>";
                                    echo "<td>" . $employeeschedule['scheduleDay'] . "</td>";
                                    echo "<td>" . $employeeschedule['startTime'] . "</td>";
                                    echo "<td>" . $employeeschedule['endTime'] . "</td>";
                                    echo "<td>" . $employeeschedule['bookAvail'] . "</td>";
                                    echo "<form method='POST'>";
                                    echo "<td class='text-center'><a href='#' id='".$employeeschedule['scheduleId']."' class='delete'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>
                            </td>";
