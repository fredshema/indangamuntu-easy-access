...
<html lang="en">
    <head>
        ...
        <title>Welcome Administrator <?php echo $userRow['employeeFirstName'];?> <?php echo $userRow['employeeLastName'];?></title>
        <!-- Bootstrap Core CSS -->
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li>
                            <a href="citizenlist.php"><i class="fa fa-fw fa-edit"></i> Appointmnet  List</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
                    ...
                    <div class="panel panel-primary filterable">
                       ...
                       <div class="panel-heading">
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    <th><input type="text" class="form-control" placeholder="Ic number" disabled></th>
                            ...
                            while ($appointment=mysqli_fetch_array($res)) {
                                ...
                                echo "<tr class='$status'>";
                                    echo "<td>" . $appointment['citizenIc'] . "</td>";
                                    echo "<td>" . $appointment['citizenLastName'] . "</td>";
                                    echo "<td>" . $appointment['citizenPhone'] . "</td>";
                                    echo "<td>" . $appointment['citizenEmail'] . "</td>";
