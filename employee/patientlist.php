...
<head>
    ...
    <title>Welcome Employee <?php echo $userRow['employeeFirstName']; ?> <?php echo $userRow['employeeLastName']; ?></title>
    <!-- Bootstrap Core CSS -->
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="employeedashboard.php">Welcome Emp <?php echo $userRow['employeeFirstName']; ?> <?php echo $userRow['employeeLastName']; ?></a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-primary filterable">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">List of Appointment</h3>
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    <th><input type="text" class="form-control" placeholder="person Ic" disabled></th>
                            ...
                            <?php
                            $result = mysqli_query($con, "SELECT * FROM citizen");



                            while ($citizenRow = mysqli_fetch_array($result)) {
                                ...
                                // echo "<td>" . $citizenRow['citizenEmail'] . "</td>";
                                echo "<td>" . $citizenRow['citizenGender'] . "</td>";
                                echo "<td>" . $citizenRow['citizenMaritialStatus'] . "</td>";
