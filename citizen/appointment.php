...
$res = mysqli_query($con, "SELECT a.*, b.* FROM schedules a INNER JOIN citizens b
WHERE a.id=$scheduleID AND b.id=$session");

$userRow = mysqli_fetch_array($res, MYSQLI_ASSOC);

//INSERT
if (isset($_POST['appointment'])) {
	$citizenID = mysqli_real_escape_string($con, $userRow['id']);
	$scheduleid = mysqli_real_escape_string($con, $scheduleID);
	$availability = "Not available";


	$query = "INSERT INTO appointments (citizen_id, schedule_id) VALUES('$citizenID','$scheduleid')";

	//update table appointment schedule
	$sql = "UPDATE schedules SET availability='$availability' WHERE id='$scheduleid'";
	...
	<nav class="navbar navbar-default " role="navigation">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="citizen.php"><img alt="Brand" src="assets/img/logo.png" height="40px"></a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<ul class="nav navbar-nav">
						...
						<li><a href="profile.php?citizenId=<?php echo $userRow['id']; ?>">Profile</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li>
								<a href="profile.php?citizenId=<?php echo $userRow['id']; ?>"><i class="fa fa-fw fa-user"></i> Profile</a>
							</li>
							<li>
								<a href="citizenapplist.php?citizenId=<?php echo $userRow['id']; ?>"><i class="glyphicon glyphicon-file"></i> Appointment</a>
							</li>
							<li class="divider"></li>
							<li>
							...
							<div class="panel panel-default">
								<div class="panel-body">
									...
									<form class="form" role="form" method="POST" accept-charset="UTF-8">
										<div class="panel panel-default">
											<div class="panel-heading">Citizen Information</div>
											<div class="panel-body">

												Names: <?php echo $userRow['names'] ?><br>
												Phone number: <?php echo $userRow['phone'] ?><br>
