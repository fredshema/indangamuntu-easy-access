...
// on b.icCitizen = a.icCitizen
$res = mysqli_query($con,"SELECT a.*, b.* FROM employeeschedule a INNER JOIN citizen b
WHERE a.scheduleDate='$appdate' AND scheduleId=$appid AND b.icCitizen=$session");
...
$citizenIc = mysqli_real_escape_string($con,$userRow['icCitizen']);
...
$query = "INSERT INTO appointment (  citizenIc , scheduleId , appSymptom , appComment  )
VALUES ( '$citizenIc', '$scheduleid', '$symptom', '$comment') ";

//update table appointment schedule
$sql = "UPDATE employeeschedule SET bookAvail = '$avail' WHERE scheduleId = $scheduleid" ;
										...
										<form class="form" role="form" method="POST" accept-charset="UTF-8">
											<div class="panel panel-default">
												...
												<div class="panel-body">
													...
													Citizen Name: <?php echo $userRow['citizenFirstName'] ?> <?php echo $userRow['citizenLastName'] ?><br>
													Citizen IC: <?php echo $userRow['icCitizen'] ?><br>
													Contact Number: <?php echo $userRow['citizenPhone'] ?><br>
													Address: <?php echo $userRow['citizenAddress'] ?>
												</div>
											</div>
											<div class="panel panel-default">
