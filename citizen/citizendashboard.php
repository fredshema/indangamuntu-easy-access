    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="citizendashboard.html">Peaple Dashboard</a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo $userRow['names']; ?><b class="caret"></b></a>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="citizenprofile.php?citizenEmail=<?php echo $userRow['citizenEmail']; ?>"><i class="fa fa-fw fa-bar-chart-o"></i> Profile</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <!-- table to display employee schedule start -->
                            <div id="txtHint"><b> NIDA schedule will be list here</b></div>
                            <!-- table to display employee schedule end -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <h1><?php echo $userRow['citizenEmail']; ?><?php echo $userRow['password']; ?></h1>
