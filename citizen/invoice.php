                ...
                <tr class="information">
                    <td colspan="2">
                        <table>
                            <tr>
                                <td>
                                    <?php echo $userRow['citizenAddress'];?>
                                </td>
                                
                                <td><?php echo $userRow['citizenIc'];?><br>
                                    <?php echo $userRow['citizenFirstName'];?> <?php echo $userRow['citizenLastName'];?><br>
                                    <?php echo $userRow['citizenEmail'];?>
                                </td>
                            </tr>
                        </table>
                    </td>
